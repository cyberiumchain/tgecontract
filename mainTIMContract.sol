 ...
 */
 //CanReclaimToken
contract TIMToken is StandardToken, PausableToken, MintableToken, HasNoTokens {

  string public constant name = "TIMToken";
   ...
   */
  function TIMToken() public {
    totalSupply_ = INITIAL_SUPPLY;
    balances[msg.sender] = INITIAL_SUPPLY;
    maxSupply = 1100000000 * (10 ** uint256(decimals));//Max 1100 M Tokens
